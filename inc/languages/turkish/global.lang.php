...
$l['welcome_newposts'] = 'Son Gönderiler';
$l['welcome_todaysposts'] = 'Bugünkü Gönderiler';
$l['welcome_pms'] = 'Özel Mesajlar';
$l['welcome_pms_usage'] = '{1}';
$l['welcome_back'] = '<strong>Hoş geldin, {1}</strong>. Son Ziyaretin: {2}';
...
$l['forumbit_posts'] = 'Gönderi';
$l['forumbit_lastpost'] = 'Son Gönderi';
$l['forumbit_moderated_by'] = 'Yetkili:';
...
$l['viewing_one'] = '(1 oyuncu aktif)';
$l['viewing_multiple'] = '({1} oyuncu aktif)';
$l['by'] = 'Yazar:';
$l['more_subforums'] = '{1} alt forum daha var.';
$l['password_required'] = 'Giriş yapabilmen için şifre gerekiyor.';
$l['forum_password_note'] = '<p><img src="images/icons/uyari.gif" alt="" style="vertical-align: middle;" height="14" width="14" /> <strong>Uyarı:</strong> Site Yönetimi Tarafından Şifrelenmiş Bir Foruma Girmeye Çalışıyorsun.</p> Bu foruma erişebilmek ve işlem yapabilmek için site yetkililerinden şifre alman gerekiyor.<br />Eğer bir şifren varsa lütfen aşağıdaki metin kutusuna yazarak giriş yap.';
$l['enter_password_below'] = '<center>(Lütfen şifreni aşağıdaki metin kutusuna yaz)</center>';
$l['verify_forum_password'] = 'Giriş Yap';
$l['wrong_forum_password'] = 'Girdiğin şifre yanlış. Lütfen şifreni kontrol edip tekrar dene.';
...
$l['remember_me_desc'] = 'Bu seçenek, çıkış yapmadığın sürece her ziyaretinde giriş bilgilerinin otomatik olarak hatırlanmasını sağlar.';
$l['month_1'] = 'Ocak';
$l['month_2'] = 'Şubat';
$l['month_3'] = 'Mart';
$l['month_4'] = 'Nisan';
...
$l['nobody'] = 'Hiç Kimse';
$l['attachments'] = 'Ekler';
$l['attachments_desc'] = 'İstersen bu gönderiye bir veya daha fazla ek dosya ekleyebilirsin. Lütfen sağ taraftan dosyayı seçip \'Ek Dosya Yükle\' butonuna tıkla.';
...
$l['attachment_too_many_files'] = 'Tek seferde en fazla {1} dosya yükleyebilirsin.';
$l['attachment_max_allowed_files'] = "Bu gönderiye {1} dosya daha ekleyebilirsin.";
$l['attachment_too_big_upload'] = 'Tek seferde en fazla {1} MB boyutunda dosya yükleyebilirsin.';
...
$l['thread_subscription_method_desc'] = 'Bu konudaki önemli gelişmelerden haberdar olmak istiyorsan, konuya abone olabilir ve bildirim türünü belirtebilirsin (Bu özellik sadece kayıtlı oyuncular içindir).';
...
$l['postbit_reputation'] = 'İtibar Puanı:';
$l['postbit_reputation_add'] = 'isimli oyuncuya İtibar Puanı ver!';
...
$l['postbit_qrestore_post'] = 'Bu Gönderiyi Geri Getir/Onayla';
...
$l['postbit_edit'] = 'Bu Gönderiyi Düzenle/Sil';
...
$l['postbit_currently_ignoring_user'] = 'Bu Konu veya Gönderi içeriği gizlidir. Çünkü, <strong>{1}</strong> adlı oyuncu senin engelli listende bulunmaktadır.<br />Bu engeli kaldırmak istiyorsan <a rel="nofollow" href="usercp.php?action=editlists"><strong>Buradan</strong></a> Engelliler Listesine giderek <strong>{1}</strong> adlı oyuncunun engelini kaldırabilirsin.<br />Veya engeli kaldırmadan, sağ taraftaki <strong>(Gizli İçeriği Göster)</strong> butonuna tıklayıp gönderi içeriğini görebilirsin.';
$l['postbit_post_under_moderation'] = 'Şu an gönderin yetkili onayını beklemektedir. Bir yetkili tarafından onaylandıktan sonra herkese görünür hale gelecektir.';
$l['postbit_warning_level'] = 'Uyarı Puanı:';
$l['postbit_warn'] = 'Bu Gönderi için Uyarı Ver';
...
$l['postbit_button_reputation_add'] = '+ İtibar';
...
$l['redirect'] = 'Yönlendiriliyorsun, Lütfen bekle...';
$l['unknown_error'] = 'Sebebi bilinmeyen bir hata oluştu.';
$l['post_fetch_error'] = 'Gönderi(ler) geri getirilirken bir hata oluştu.';
$l['ratings_update_error'] = "Puan(lar) güncellenirken bir hata oluştu.";
$l['smilieinsert'] = 'İfadeler';
$l['smilieinsert_getmore'] = 'Daha Fazlası';
$l['on'] = 'Açık';
$l['off'] = 'Kapalı';
$l['remote_avatar_disabled_default_avatar'] = 'Şu anda geçersiz bir uzaktan bağlantı avatarı kullanıyorsun. Bunun yerine varsayılan avatar kullanılacaktır.';
$l['mod_notice'] = 'Yetkili onayı bekleniyor: {1}.';
...
$l['unapproved_posts'] = '{1} tane onaylanmamış gönderi.';
...
$l['go'] = 'Git';
$l['bbclosed_warning'] = '<img src="images/icons/uyari.gif" alt="" style="vertical-align: middle;" height="14" width="14" /> <strong>Topluluk Durumu:</strong> Şu anda kullanıma kapalı';
$l['banned_warning'] = 'Topluluğumuzdaki üyelik hesabın yetkili kararı ile yasaklanmıştır.<br />';
$l['banned_warning2'] = '<u>Yasaklanma sebebi</u>';
$l['banned_warning3'] = '<u>Hesabın tekrar aktif olma süresi</u>';
$l['banned_lifted_never'] = 'Süresiz yasaklandın.';
$l['banned_email_warning'] = 'E-posta adresinin yasaklı listesinde olduğu tespit edildi. Lütfen devam etmeden önce e-posta adresini yenile.';
...
$l['quickdelete_confirm'] = 'Bu gönderiyi silmek istediğinden emin misin?';
$l['quickrestore_confirm'] = 'Bu gönderiyi onarmak/geri getirmek istediğinden emin misin?';
$l['newpm_notice_one'] = '<strong>{1}</strong> adlı oyuncudan <strong>yeni bir özel mesaj</strong> aldın. <strong>Mesaj Başlığı:</strong> <a rel="nofollow" href="{2}/private.php?action=read&amp;pmid={3}" style="font-weight: bold;">{4}</a>';
$l['newpm_notice_multiple'] = '<strong>Okunmamış toplam {1} adet yeni özel mesajın var.</strong><br /> Son Gönderen: <strong>{2}</strong>, Mesaj Başlığı: <a rel="nofollow" href="{3}/private.php?action=read&amp;pmid={4}" style="font-weight: bold;">{5}</a>';
$l['deleteevent_confirm'] = 'Bu etkinliği silmek istediğinden emin misin?';
$l['removeattach_confirm'] = 'Bu ek dosyayı konudan tamamen silmek istediğine emin misin?';
...
$l['error_loadlimit'] = '<img src="images/icons/uyari.gif" alt="" style="vertical-align: middle;" height="14" width="14" /> Sunucu yüklenirken zaman aşımına uğradı. Lütfen daha sonra tekrar dene.';
$l['error_boardclosed'] = '<center>(<span style="color: maroon; font-weight: bold;"> Topluluğumuz şu anda kapalıdır.</span> )<br />Kapalı olma nedenimiz aşağıda yazmaktadır.</center>';
$l['error_banned'] = '<img src="images/icons/uyari.gif" alt="" style="vertical-align: middle;" height="14" width="14" /> <strong>Üzgünüz:</strong> Hesabın yetkililer tarafından yasaklanmıştır. Herhangi bir sorunun varsa yetkililer ile iletişime geçebilirsin.';
$l['error_cannot_upload_php_post'] = '<img src="images/icons/uyari.gif" alt="" style="vertical-align: middle;" height="14" width="14" /> Dosya boyutu büyük olduğundan işlem gerçekleşmedi. Lütfen geriye dönüp tekrar dene.';
$l['error_empty_post_input'] = 'Gönderi verilerin boş olduğundan dolayı bir hata oluştu. Tarayıcının geri tuşuna basarak geri dönmeni ve yeniden başlamanı öneririz.';
...
$l['ajax_loading'] = 'Lütfen Bekle.<br />Sayfa Yükleniyor...';
$l['saving_changes'] = 'Değişiklikler Kaydediliyor...';
$l['refresh'] = 'Yenile';
$l['select_language'] = 'Dili Değiştir';
$l['select_theme'] = 'Temayı Değiştir';
$l['invalid_post_code'] = 'Uygun olmayan kod hatası. Bu işlemi doğru bir şekilde yaptığından emin misin? Lütfen geri dönüp tekrar dene.';
$l['invalid_nocaptcha'] = 'Eğer bir Spam Bot veya Robot değilsen Güvenlik Kodunu doğrula. (reCAPTCHA)';
$l['invalid_hcaptcha'] = "Eğer bir Spam Bot veya Robot değilsen Güvenlik Kodunu doğrula. (hCaptcha)";
$l['invalid_captcha_verify'] = 'Girdiğin resim doğrulama kodu yanlış. Lütfen, kodu resimde göründüğü şekilde gir.';
$l['image_verification'] = 'Güvenlik Kodu:';
$l['human_verification'] = 'İnsan Doğrulama:';
$l['verification_note'] = 'Lütfen resmin üzerindeki güvenlik kodunu aşağıdaki kutuya gir.';
$l['verification_note_nocaptcha'] = 'Aşağıda görünen onay kutusunu işaretle. (reCAPTCHA)';
...
$l['error_emailflooding_1_second'] = 'Üzgünüz, fakat her {1} dakida bir sadece 1 e-posta gönderebilirsin. Yeni bir e-posta göndermeden önce birkaç saniye daha bekle.';
$l['error_emailflooding_seconds'] = 'Üzgünüz, fakat her {1} dakida bir sadece 1 e-posta gönderebilirsin. Yeni bir e-posta göndermeden önce {2} saniye daha bekle.';
$l['error_emailflooding_1_minute'] = 'Üzgünüz, fakat her {1} dakida bir sadece 1 e-posta gönderebilirsin. Yeni bir e-posta göndermeden önce 1 dakika daha bekle.';
$l['error_emailflooding_minutes'] = 'Üzgünüz, fakat her {1} dakida bir sadece 1 e-posta gönderebilirsin. Yeni bir e-posta göndermeden önce {2} dakika daha bekle.';
$l['error_invalidfromemail'] = 'Geçerli bir e-posta adresi girmedin.';
$l['error_noname'] = 'Geçerli bir isim/nick girmedin.';
$l['your_email'] = 'E-posta Adresin:';
$l['email_note'] = 'E-posta adresini gir.';
$l['your_name'] = 'İsim/Nick:';
$l['name_note'] = 'İsim veya bir nick gir.';
$l['january'] = 'Ocak';
$l['february'] = 'Şubat';
$l['march'] = 'Mart';
$l['april'] = 'Nisan';
...
$l['november'] = 'Kasım';
$l['december'] = 'Aralık';
$l['moderation_forum_attachments'] = 'Bu alanda yeni eklenen ek dosyanın görünür olması için bir yetkili tarafından onaylanması gerekiyor.';
$l['moderation_forum_posts'] = 'Bu alanda yeni yazılan gönderilerin görünür olması için bir yetkili tarafından onaylanması gerekiyor.';
$l['moderation_user_posts'] = 'Lütfen yazdığın gönderilerin görünür olması için yetkili onayı gerektiğini unutma.';
$l['moderation_forum_thread'] = 'Bu alanda yeni açılan konuların görünür olması için bir yetkili tarafından onaylanması gerekiyor.';
$l['moderation_forum_edits'] = 'Bu alanda düzenlenen konu veya gönderilerin görünür/geçerli olması için yetkili onayı gerekiyor.';
$l['moderation_forum_edits_quick'] = 'Lütfen, gönderini düzenledikten sonra tekrar yetkili onayı gerektiğini unutma.';
...
$l['awaiting_message_single'] = '<strong>1</strong> yeni oyuncu aktivasyon bekliyor. Lütfen aktivasyon bekleyen oyuncuyu onayla.';
$l['awaiting_message_plural'] = 'Toplam <strong>{1}</strong> yeni oyuncu aktivasyon bekliyor. Lütfen aktivasyon bekleyenleri onayla.';
$l['select2_match'] = 'Bir sonuç mevcut, gezinmek için aşağı ve yukarı ok tuşlarını kullan.';
$l['select2_matches'] = '{1} sonuç mevcut, gezinmek için aşağı ve yukarı ok tuşlarını kullan.';
$l['select2_nomatches'] = 'Hiçbir sonuç bulunamadı.';
$l['select2_inputtooshort_single'] = 'Lütfen, bir veya daha fazla karakter gir.';
$l['select2_inputtooshort_plural'] = 'En az {1} karakter gir.';
$l['select2_inputtoolong_single'] = 'Lütfen, bir karakter sil.';
$l['select2_inputtoolong_plural'] = 'Lütfen, {1} karakter sil.';
$l['select2_selectiontoobig_single'] = 'Yalnızca bir öge seçebilirsin.';
$l['select2_selectiontoobig_plural'] = 'Yalnızca {1} öge seçebilirsin.';
...
$l['stopforumspam_invalid_email'] = 'Geçersiz bir e-posta adresi girdin.';
$l['stopforumspam_invalid_ip_address'] = 'Geçersiz bir IP adresi girdin.';
...
$l['expcol_collapse'] = '[-]';
$l['expcol_expand'] = '[+]';
$l['boardclosed_reason'] = 'Bu topluluk onarım ve bakım çalışmalarından dolayı kısa bir süreliğine kapalıdır.<br />Lütfen daha sonra tekrar ziyaret et.<br /> Anlayışın için teşekkürler.';
