...
$l['template_group_prefix_desc'] = "Yeni ''Grup Şablonu'' için bir (Ön Ek) isim/takı giriniz. Gireceğiniz bu ön ek var olmayan bir şablon grubu ön eki olmalıdır.<br /><strong>Örnek:</strong> Ön ekimiz <strong>MYBB</strong> olsun, <strong>MYBB</strong> adında bir ana şablon grubu oluşturduk diyelim, daha sonra bu ana şablon grubu içinde de <strong><em>MYBB_DENEME</em></strong> adında <strong>''Yeni Şablon Ekle''</strong> kısmından alt şablonumuzu veya şablonlarımızı oluşturarak kendimize özel daha doğrusu temamıza özel  tıpkı Header ve Header şablonlarındaki alt şablonlar gibi bir şablon grubu oluşturmuş oluruz.<br />(Özel Karakterler Haricinde, Büyük/Küçük ve Türkçe Karakterli Harfler Kullanabilirsiniz).";
$l['template_group_title'] = "Şablon Grubu için Bir (Başlık) Giriniz:";
$l['template_group_title_desc'] = "Şablon Grupları listesinde görünecek olan bir başlık giriniz.<br /><strong>Örnek:</strong> <strong><em>MyBB</em></strong> adında bir başlık kullanarak şablon grupları listesinde de <strong><em>MyBB</em></strong> adı ile listelenmesini sağlayabilirsiniz. Başlığınız ön eki ile aynı olabilir fakat, ön ekinden farklı bir başlık kullanmanız karmaşalık oluşturmaması için tavsiye edilir. Burada dikkat edilmesi gereken nokta, <strong>''Yeni Şablon Ekle''</strong> kısmında şablon başlığı yerine şablon ekini girmenizdir. Kısaca, oluşturmak istediğiniz şablonun hangi ''şablon grubu altında'' listelenmesini istiyorsanız o grubun ön ekini girmeniz yeterlidir.<br />(Büyük/Küçük, Türkçe ve Özel Karakterli Harfler/Semboller Kullanabilirsiniz).";
...
$l['error_security_problem'] = "Potansiyel bir şablon güvenliği sorunu tespit edildi. Lütfen, son yaptığınız değişiklikleri gözden geçirip sorunu düzeltin veya yardım almak için <b><a href=\"https://mybbturkce.com\" target=\"_blank\" title=\"MyBB Destek Forumu\">MyBB Destek Forumu</a>&nbsp;<img src=\"../images/ikon/external_link.png\" alt=\"\" height=\"9\" width=\"9\"></b>nu ziyaret ediniz.";
...
$l['error_invalid_group_title'] = "Alt tireler (_) ayırıcı olarak kullanıldığı için şablon grubu öneklerinde yasaklanmıştır. Lütfen başka bir önek seçin.";
