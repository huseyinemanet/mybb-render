...
$l['mass_prune_info'] = "Bu eylem {1} kullanıcıyı etkileyecektir. Devam ederseniz, tüm kullanıcıların yayınladığı mesajları aşağıda girdiğiniz tarihten daha eski olanlar kaldırılacaktır.<br /><br /><strong>Herhangi bir kullanıcının gönderdiği mesajın, kullanıcının ilk mesajı olabileceğini unutmayın! Devam ederseniz bu mesajlar da dahil olmak üzere hepsi kaldırılacaktır.</strong>";
...
$l['hide_email_from_others'] = "Profilimdeki ''E-Posta Gönder'' bağlantısını Gizle?";
$l['recieve_pms_from_others'] = "Tüm kullanıcılar Özel Mesaj gönderebilsin?";
$l['recieve_pms_from_buddy'] = "Sadece arkadaş listemde ekli kullanıcılar Özel Mesaj gönderebilsin? (Bu ayarın etkili olabilmesi için listede en az bir arkadaşınız olması gerekir.)";
...
$l['instant_pm_notification'] = "Anında ÖM Bildirimi Gönderilsin";
...
$l['moderated_perm'] = "<p><small>Kalıcı olarak moderasyona alındı.<br />Bu moderasyon işlemini iptal etmek için üsteki kutucuğun tik işaretini kaldırın.</small></p>";
...
$l['suspended_perm'] = "<p><small>Kalıcı olarak askıya alındı.<br />Bu askıyı iptal etmek için üsteki kutucuğun tik işaretini kaldırın.</small></p>";
...
$l['google_contains'] = "Google Hangouts ID şunları içerir:";
