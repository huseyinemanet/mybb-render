 ...
 * Son Güncelleme: 14.06.2019 - Saat: 19:39
 */
...
$l['colors_add_desc'] = "Bu tema için kullanılabilir renk listesi.<br />Bu kısımda, listeye daha fazla renk eklemek için eşleştirilmiş bir anahtar ve madde giriniz.<br /><strong>Örnek:</strong> (anahtar=madde), Örneğin, <em>mybb=MyBB</em> , <em>mavi=Mavi</em> . Burada dikkat edilmesi gereken nokta, her anahtar ve madde arasında, <strong>=</strong> karakterinin kullanılmasıdır.";
...
$l['import_from_desc'] = "Bu kısımda, forumunuza yüklemek istediğiniz temanın <strong>.xml</strong> dosyasını bilgisayarınızdan veya URL adresi ile kolay bir şekilde yükleyebilirsiniz. Remember to use themes from <strong>safe and trusted sources only</strong>.";
...
$l['new_name_desc'] = "Bu kısımda, yüklemek istediğiniz tema için yeni bir isim kullanabilirsiniz. <strong>Örnek</strong> MyBBTurkce Teması gibi. <img src=\"../images/smilies/tongue.gif\" alt=\"\" width=\"18\" height=\"18\" style=\"vertical-align: middle;\">";
...
$l['editor_theme_desc'] = "Bu kısımda, konu ve hızlı cevap editörünün stilini seçiniz. Editör stilini özelleştirmek için  <strong>Ftp aracılığı ile  ./jscripts/sceditor/themes</strong> klasöründen gerekli düzenlemeleri yapabilirsiniz.";
$l['img_directory'] = "Tema Klasörünün Yolu:";
$l['img_directory_desc'] = "Bu kısımda, Bu tema için kullanılacak olan resim klasörünün yolu giriniz. Bu resim klasörü şablonlarınızda kullanılan grafik yolunu belirlemek içindir.<br /><strong>Örnek:</strong> ./images/mybb gibi.";
...
$l['theme_thumbnail'] = "Tema Küçük Resmi";
...
$l['error_theme_security_problem'] = "Güvenlik sorunu oluşturabilecek yüklü bir tema tespit edildi. Lütfen, son yüklediğiniz tema-ları kontrol edip güvenlik sorununu düzeltin veya yadım almak için <strong><a href=\"https://mybbturkce.com\" target=\"_blank\" title=\"MyBB Destek Forumu\">MyBB Destek Forumu</a>&nbsp;<img src=\"../images/icons/external_link.png\" alt=\"\" height=\"8\" width=\"8\"></strong>nu ziyaret ediniz.";
...
$l['error_invalid_color'] = "\"{1}\" tanımlı renk şeması ya geçersiz karakterlere sahip ya da belirtilen formatta değil. '=' ile ayrılmış adlandırmalar için yalnızca sayılara, unicode harflere ve alt cizgilere izin verilir.";
